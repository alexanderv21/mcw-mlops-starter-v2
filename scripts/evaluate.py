...
print('Retrieving the training dataset...')
ds_training = latest_model.datasets['training data'][0].to_csv_files()
ds_training.download(target_path='dataset', overwrite=True)
os.rename('dataset/part-00000', 'dataset/training_data.csv')
...
image_config = ContainerImage.image_configuration(execution_script = 'score_fixed.py', 
                                                dependencies = ['dataset/training_data.csv'],
